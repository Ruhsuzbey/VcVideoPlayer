...
async def cb_handler(client: Client, query: CallbackQuery):
    if query.data=="help":
        ...
        buttons = [
            ...
            [
                InlineKeyboardButton("Alem", url="https://t.me/Alem_Sohbet"),
                InlineKeyboardButton("Üniversite", url="https://t.me/Universite_Sohbet"),
            ],
            [
                InlineKeyboardButton("kanal", url="https://t.me/korsanfed"),
                InlineKeyboardButton("Zᴀʟɪᴍ", url="https://t.me/cakiltasim"),
            ],
            [
                InlineKeyboardButton("Bᴀᴄᴋ", callback_data="start"),
            ]
